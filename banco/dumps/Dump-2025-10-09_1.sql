...
CREATE TABLE `tbusuario` (
  ...
  UNIQUE KEY `un_EmailUsuariotbUsuario` (`email_usuario`),
  CONSTRAINT `ch_TipoUsuariotbUsuario` CHECK ((`tipo_usuario` in (_utf8mb4'User',_utf8mb4'Admin')))
...
-- Dump completed on 2025-10-09 15:07:27
